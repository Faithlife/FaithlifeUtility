...
namespace Faithlife.Utility
{
	...
	public static class EnumUtility
	{
		...
		public static T[] GetValues<T>()
			where T : struct => (T[]) Enum.GetValues(typeof(T));
		...
		public static T Parse<T>(string value)
			where T : struct => Parse<T>(value, CaseSensitivity.MatchCase);
		...
		public static T Parse<T>(string value, CaseSensitivity caseSensitivity)
			where T : struct => (T) Enum.Parse(typeof(T), value, caseSensitivity == CaseSensitivity.IgnoreCase);
		...
		public static T? TryParse<T>(string? value)
			where T : struct => TryParse<T>(value, CaseSensitivity.MatchCase);
		...
		public static T? TryParse<T>(string? value, CaseSensitivity caseSensitivity)
			where T : struct => Enum.TryParse<T>(value, caseSensitivity == CaseSensitivity.IgnoreCase, out var result) ? result : default(T?);
		...
		public static bool TryParse<T>(string? value, out T result)
			where T : struct => TryParse(value, CaseSensitivity.MatchCase, out result);
		...
		public static bool TryParse<T>(string? value, CaseSensitivity caseSensitivity, out T result)
			where T : struct => Enum.TryParse(value, caseSensitivity == CaseSensitivity.IgnoreCase, out result);
	}
}
